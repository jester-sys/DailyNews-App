...
import com.medi.OpenAI.adapter.MessageAdapter;
import com.medi.dailynews.MainActivity;
import com.medi.dailynews.databinding.ActivityChatBotBinding;
...
public class ChatBotActivity extends AppCompatActivity {
    ...
    void callAPI(String question){
        ...
        Request request = new Request.Builder()
                ...
                .header("Authorization","Bearer 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")
                .post(body)
                .build();
