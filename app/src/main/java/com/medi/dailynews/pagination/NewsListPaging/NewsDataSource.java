...
public class NewsDataSource extends PageKeyedDataSource<Integer, Article> {
    ...
    public NewsDataSource(ApiService apiService, Context context, String keyword) {
        this.apiService = apiService;
        this.context = context; // Use application context to avoid potential memory leaks
        this.keyword = keyword;
    }
    public NewsDataSource(ApiService apiService, Context context) {
        this.apiService = apiService;
        this.context = context; // Use application context to avoid potential memory leaks
    }
    ...
    public void loadInitial(@NonNull LoadInitialParams<Integer> params, @NonNull LoadInitialCallback<Integer, Article> callback) {
        ...
        Call<NewsResponse> call = apiService.getNewsArticles("in", "general", keyword, Utils.API_KEY, currentPage, pageSize);
    ...
    public void loadBefore(@NonNull LoadParams<Integer> params, @NonNull LoadCallback<Integer, Article> callback) {
        // Not used in your case, as you are loading data in a forward direction
    }
}
